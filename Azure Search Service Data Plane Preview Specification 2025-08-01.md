---
title:
source: "https://raw.githubusercontent.com/Azure/azure-rest-api-specs/refs/heads/main/specification/search/data-plane/Azure.Search/preview/2025-08-01-preview/searchservice.json"
author:
published:
created: 2025-07-31
description:
  ...
  "paths": {
    "/agents('{agentName}')": {
      "put": {
        ...
        "x-ms-examples": {
          "SearchServiceCreateOrUpdateKnowledgeAgent": {
            "$ref": "./examples/SearchServiceCreateOrUpdateKnowledgeAgent.json"
          }
        },
        ...
        "parameters": [
          ...
          },
          {
            ...
            "required": true,
            "schema": {
              "$ref": "#/definitions/KnowledgeAgent"
            },
            "description": "The definition of the agent to create or update."
          },
          {
      ...
      "delete": {
        ...
        "operationId": "KnowledgeAgents_Delete",
        "x-ms-examples": {
          "SearchServiceDeleteKnowledgeAgent": {
            "$ref": "./examples/SearchServiceDeleteKnowledgeAgent.json"
          }
        },
      ...
      "get": {
        ...
        "operationId": "KnowledgeAgents_Get",
        "x-ms-examples": {
          "SearchServiceGetKnowledgeAgent": {
            "$ref": "./examples/SearchServiceGetKnowledgeAgent.json"
          }
        },
        "description": "Retrieves an agent definition.",
        "parameters": [
          {
            "name": "agentName",
            "in": "path",
      ...
      "get": {
        ...
        "x-ms-examples": {
          "SearchServiceListKnowledgeAgents": {
            "$ref": "./examples/SearchServiceListKnowledgeAgents.json"
          }
        },
        "description": "Lists all agents available for a search service.",
        "parameters": [
          {
            "$ref": "#/parameters/ClientRequestIdParameter"
          },
        ...
        "responses": {
          "200": {
            "description": "",
            "schema": {
              "$ref": "#/definitions/ListKnowledgeAgentsResult"
            }
          },
          "default": {
            "description": "Error response.",
      ...
      "post": {
        ...
        "x-ms-examples": {
          "SearchServiceCreateKnowledgeAgent": {
            "$ref": "./examples/SearchServiceCreateKnowledgeAgent.json"
          }
        },
        ...
        "parameters": [
          {
            ...
            "description": "The definition of the agent to create."
          },
          {
            "$ref": "#/parameters/ClientRequestIdParameter"
          },
      ...
      "put": {
        ...
        "x-ms-examples": {
          "SearchServiceCreateOrUpdateKnowledgeSource": {
            "$ref": "./examples/SearchServiceCreateOrUpdateKnowledgeSource.json"
          },
          "SearchServiceCreateOrUpdateKnowledgeSourceAzureBlob": {
            "$ref": "./examples/SearchServiceCreateOrUpdateKnowledgeSourceAzureBlob.json"
          },
        ...
        "parameters": [
          {
            ...
            "required": true,
            "type": "string",
            "description": "The name of the knowledge source to create or update."
          },
          {
      ...
      "delete": {
        ...
        "x-ms-examples": {
          "SearchServiceDeleteKnowledgeSource": {
            "$ref": "./examples/SearchServiceDeleteKnowledgeSource.json"
          },
          "SearchServiceDeleteKnowledgeSourceAzureBlob": {
            "$ref": "./examples/SearchServiceDeleteKnowledgeSourceAzureBlob.json"
          },
          "SearchServiceDeleteKnowledgeSourceWeb": {
            "$ref": "./examples/SearchServiceDeleteKnowledgeSourceWeb.json"
          }
        },
        ...
        "parameters": [
          {
            ...
            "required": true,
            "type": "string",
            "description": "The name of the knowledge source to delete."
          },
          {
            "$ref": "#/parameters/ClientRequestIdParameter"
          },
      ...
      "get": {
        ...
        "x-ms-examples": {
          "SearchServiceGetKnowledgeSource": {
            "$ref": "./examples/SearchServiceGetKnowledgeSource.json"
          },
          "SearchServiceGetKnowledgeSourceAzureBlob": {
            "$ref": "./examples/SearchServiceGetKnowledgeSourceAzureBlob.json"
          },
      ...
      "get": {
        ...
        "x-ms-examples": {
          "SearchServiceListKnowledgeSources": {
            "$ref": "./examples/SearchServiceListKnowledgeSources.json"
          },
          "SearchServiceListKnowledgeSourcesAzureBlob": {
            "$ref": "./examples/SearchServiceListKnowledgeSourcesAzureBlob.json"
          },
      ...
      "post": {
        ...
        "x-ms-examples": {
          "SearchServiceCreateKnowledgeSource": {
            "$ref": "./examples/SearchServiceCreateKnowledgeSource.json"
          },
          "SearchServiceCreateKnowledgeSourceAzureBlob": {
            "$ref": "./examples/SearchServiceCreateKnowledgeSourceAzureBlob.json"
          },
        ...
        "responses": {
          "201": {
            "description": "Successfully created an knowledge source",
            "schema": {
              "$ref": "#/definitions/KnowledgeSource"
            }
          },
    ...
    "/datasources('{dataSourceName}')": {
      "put": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Update-Data-Source"
        },
        "parameters": [
          {
            "name": "dataSourceName",
      ...
      "delete": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Delete-Data-Source"
        },
        "parameters": [
          {
            "name": "dataSourceName",
      ...
      "get": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Get-Data-Source"
        },
        "parameters": [
          {
            "name": "dataSourceName",
    ...
    "/datasources": {
      "get": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/List-Data-Sources"
        },
        "parameters": [
          {
            "name": "$select",
    ...
    "/indexers('{indexerName}')/search.reset": {
      "post": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Reset-Indexer"
        },
        "parameters": [
          {
            "name": "indexerName",
    ...
    "/indexers('{indexerName}')/search.resync": {
      "post": {
        ...
        "x-ms-examples": {
          "SearchServiceResync": {
            "$ref": "./examples/SearchServiceResync.json"
          }
        },
        "description": "Resync selective options from the datasource to be re-ingested by the indexer.",
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Resync-Indexer"
        },
        "parameters": [
          {
            "name": "indexerName",
            ...
            "required": true,
            "type": "string",
            "description": "The name of the indexer to resync for."
          },
          {
            "name": "indexerResync",
            "in": "body",
            ...
            "schema": {
              "type": "object",
              "x-ms-client-name": "IndexerResyncBody",
              "properties": {
                "options": {
                  "type": "array",
    ...
    "/indexers('{indexerName}')/search.run": {
      "post": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Run-Indexer"
        },
        "parameters": [
          {
            "name": "indexerName",
    ...
    "/indexers('{indexerName}')": {
      "put": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Create-Indexer"
        },
        "parameters": [
          {
            "name": "indexerName",
      ...
      "delete": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Delete-Indexer"
        },
        "parameters": [
          {
            "name": "indexerName",
      ...
      "get": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Get-Indexer"
        },
        "parameters": [
          {
            "name": "indexerName",
    ...
    "/indexers": {
      "get": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/List-Indexers"
        },
        "parameters": [
          {
            "name": "$select",
    ...
    "/indexers('{indexerName}')/search.status": {
      "get": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Get-Indexer-Status"
        },
        "parameters": [
          {
            "name": "indexerName",
    ...
    "/skillsets('{skillsetName}')": {
      "put": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/update-skillset"
        },
        "parameters": [
          {
            "name": "skillsetName",
      ...
      "delete": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/delete-skillset"
        },
        "parameters": [
          {
            "name": "skillsetName",
      ...
      "get": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/get-skillset"
        },
        "parameters": [
          {
            "name": "skillsetName",
    ...
    "/skillsets": {
      "get": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/list-skillset"
        },
        "parameters": [
          {
            "name": "$select",
      ...
      "post": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/create-skillset"
        },
        "parameters": [
          {
            "name": "skillset",
    ...
    "/synonymmaps('{synonymMapName}')": {
      "put": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Update-Synonym-Map"
        },
        "parameters": [
          {
            "name": "synonymMapName",
      ...
      "delete": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Delete-Synonym-Map"
        },
        "parameters": [
          {
            "name": "synonymMapName",
      ...
      "get": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Get-Synonym-Map"
        },
        "parameters": [
          {
            "name": "synonymMapName",
    ...
    "/synonymmaps": {
      "get": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/List-Synonym-Maps"
        },
        "parameters": [
          {
            "name": "$select",
      ...
      "post": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Create-Synonym-Map"
        },
        "parameters": [
          {
            "name": "synonymMap",
    ...
    "/indexes": {
      "post": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Create-Index"
        },
        "parameters": [
          {
            "name": "index",
      ...
      "get": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/List-Indexes"
        },
        "parameters": [
          {
            "name": "$select",
    ...
    "/indexes('{indexName}')": {
      "put": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Update-Index"
        },
        "parameters": [
          {
            "name": "indexName",
      ...
      "delete": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Delete-Index"
        },
        "parameters": [
          {
            "name": "indexName",
      ...
      "get": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Get-Index"
        },
        "parameters": [
          {
            "name": "indexName",
    ...
    "/indexes('{indexName}')/search.stats": {
      "get": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Get-Index-Statistics"
        },
        "parameters": [
          {
            "name": "indexName",
    ...
    "/indexes('{indexName}')/search.analyze": {
      "post": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/test-analyzer"
        },
        "parameters": [
          {
            "name": "indexName",
    ...
    "/aliases": {
      "post": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Create-Alias"
        },
        "parameters": [
          {
            "name": "alias",
      ...
      "get": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/List-Aliases"
        },
        "parameters": [
          {
            "$ref": "#/parameters/ClientRequestIdParameter"
    ...
    "/aliases('{aliasName}')": {
      "put": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Update-Alias"
        },
        "parameters": [
          {
            "name": "aliasName",
      ...
      "delete": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Delete-Alias"
        },
        "parameters": [
          {
            "name": "aliasName",
      ...
      "get": {
        ...
        "externalDocs": {
          "url": "https://learn.microsoft.com/rest/api/searchservice/Get-Alias"
        },
        "parameters": [
          {
            "name": "aliasName",
    ...
    "/indexstats": {
      "get": {
        ...
        "responses": {
          "200": {
            "description": "Statistics summary for all indexes.",
            "schema": {
  ...
  "definitions": {
    "KnowledgeAgent": {
      ...
      "properties": {
        "name": {
          "type": "string",
          "description": "The name of the knowledge agent."
        },
        "models": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/KnowledgeAgentModel"
          },
        ...
        "outputConfiguration": {
          "$ref": "#/definitions/KnowledgeAgentOutputConfiguration"
        },
        "requestLimits": {
          "$ref": "#/definitions/KnowledgeAgentRequestLimits"
        },
        "retrievalInstructions": {
          "type": "string",
          "description": "Instructions considered by the knowledge agent when developing query plan."
        },
        "@odata.etag": {
        ...
        "encryptionKey": {
          ...
          "description": "A description of an encryption key that you create in Azure Key Vault. This key is used to provide an additional level of encryption-at-rest for your agent definition when you want full assurance that no one, not even Microsoft, can decrypt them. Once you have encrypted your agent definition, it will always remain encrypted. The search service will ignore attempts to set this property to null. You can change this property as needed if you want to rotate your encryption key; Your agent definition will be unaffected. Encryption with customer-managed keys is not available for free search services, and is only available for paid services created on or after January 1, 2019.",
          "externalDocs": {
    ...
    "KnowledgeSourceReference": {
      ...
      "properties": {
        ...
        "maxSubQueries": {
          "type": "integer",
          "format": "int32",
          "description": "The maximum number of queries that can be issued at a time when retrieving data from this source."
        },
        "rerankerThreshold": {
          "type": "number",
          "format": "float",
    ...
    "KnowledgeAgentOutputConfiguration": {
      ...
      "properties": {
        "modality": {
          ...
          "x-ms-enum": {
            "name": "KnowledgeAgentOutputConfigurationModality",
            "modelAsString": true,
            "values": [
              {
          ...
          "description": "The output configuration for the agent"
        },
        "answerInstructions": {
          "type": "string",
          "description": "Instructions considered by the knowledge agent when generating answers"
        },
        "attemptFastPath": {
          "type": "boolean",
          "description": "Indicates whether the agent should attempt to issue the most recent chat message as a direct query to the knowledge sources, bypassing the model calls."
        },
        "includeActivity": {
          "type": "boolean",
    ...
    "KnowledgeAgentRequestLimits": {
      ...
      "description": "Guardrails to limit how much resources are utilized for a single agent retrieval request."
    },
    "ListKnowledgeAgentsResult": {
      "type": "object",
      "properties": {
        "value": {
          "x-ms-client-name": "KnowledgeAgents",
          "type": "array",
          "items": {
            "$ref": "#/definitions/KnowledgeAgent"
          }
    ...
    "KnowledgeAgentModel": {
      ...
      "properties": {
        "kind": {
          "$ref": "#/definitions/KnowledgeAgentModelKind",
    ...
    "KnowledgeAgentAzureOpenAIModel": {
      ...
      "properties": {
        "azureOpenAIParameters": {
          ...
          "description": "Contains the parameters specific to Azure OpenAI model endpoint."
        }
      },
      "required": [
        "azureOpenAIParameters"
    ...
    "WebKnowledgeSource": {
      ...
      "properties": {
        "webParameters": {
          "$ref": "#/definitions/WebKnowledgeSourceParameters",
          "description": "The parameters for the knowledge source."
        }
      },
      "required": [
      ...
      "description": "Knowledge Source targeting web results."
    },
    "WebKnowledgeSourceParameters": {
      ...
      "properties": {
        ...
        "bingResourceId": {
          "type": "string",
          "description": "The ResourceId of the Bing Search resource to use for web results."
        },
        "language": {
          "type": "string",
        ...
        "allowedDomains": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/WebKnowledgeSourceAllowedDomain"
          },
          "description": "Domains that are allowed for web results"
        },
        "blockedDomains": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/WebKnowledgeSourceBlockedDomain"
          },
          "description": "Domains that are blocked from web results"
        }
      },
      "description": "Parameters for web knowledge source."
    },
    "WebKnowledgeSourceAllowedDomain": {
      ...
      "properties": {
        ...
        "includeSubpages": {
          "type": "boolean",
          "description": "whether or not to include subpages from this domain."
        },
        "rankingAdjustment": {
          "$ref": "#/definitions/WebKnowledgeSourceDomainRankingAdjustmentKind"
        }
      },
      "required": [
        "address"
      ],
      "description": "Configuration for web knowledge source domain."
    },
    ...
    "WebKnowledgeSourceDomainRankingAdjustmentKind": {
      ...
      "x-ms-enum": {
        "name": "WebKnowledgeSourceRankingAdjustment",
        "modelAsString": true,
        "values": [
          {
            "value": "boost",
            "name": "boost",
            "description": "Raises the ranking of the chosen domain or subpage so it appears higher in the search results."
          },
          {
            "value": "superBoost",
            "name": "superBoost",
            "description": "Applies a stronger positive weight than Boost, pushing the selected domain or subpage towards the very top of the results."
          },
          {
            "value": "demote",
            "name": "demote",
            "description": "Lowers the ranking of the specified domain or subpage so it shows up further down the results list."
          }
        ]
      },
      "description": "The ranking adjustment to perform on the web results."
    },
    ...
    "ListKnowledgeSourcesResult": {
      ...
      "properties": {
        "value": {
          "x-ms-client-name": "KnowledgeSources",
          "type": "array",
          "items": {
            "$ref": "#/definitions/KnowledgeSource"
          }
    ...
    "LexicalAnalyzer": {
      ...
      "properties": {
        ...
        "name": {
          "type": "string",
          "externalDocs": {
            "url": "https://learn.microsoft.com/rest/api/searchservice/custom-analyzers-in-azure-search#index-attribute-reference"
          },
    ...
    "StemmerTokenFilter": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/rest/api/searchservice/Custom-analyzers-in-Azure-Search#TokenFilters"
      }
    },
    ...
    "Similarity": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/index-ranking-similarity"
      }
    },
    "ClassicSimilarity": {
      "type": "object",
    ...
    "VectorSearch": {
      ...
      "properties": {
        ...
        "compressions": {
          "type": "array",
          "items": {
            "$ref": "#/definitions/VectorSearchCompressionConfiguration"
          },
    ...
    "VectorSearchProfile": {
      ...
      "properties": {
        "name": {
          "externalDocs": {
            "url": "https://learn.microsoft.com/rest/api/searchservice/Naming-rules"
          },
          "type": "string",
    ...
    "RescoringOptions": {
      "type": "object",
      "x-ms-client-name": "RescoringOptions",
      "properties": {
        "enableRescoring": {
          "type": "boolean",
          "default": true,
    ...
    "ScalarQuantizationParameters": {
      ...
      "properties": {
        "quantizedDataType": {
          "$ref": "#/definitions/VectorSearchCompressionTargetDataType",
          "x-nullable": true,
    ...
    "VectorSearchCompressionTargetDataType": {
      ...
      "x-ms-enum": {
        "name": "VectorSearchCompressionTargetDataType",
        "modelAsString": true,
        "values": [
          {
            "value": "int8",
    ...
    "WebApiVectorizer": {
      ...
      "properties": {
        "customWebApiParameters": {
          "x-ms-client-name": "WebApiParameters",
    ...
    "AIServicesVisionVectorizer": {
      ...
      "properties": {
        "aiServicesVisionParameters": {
          "x-ms-client-name": "AIServicesVisionParameters",
    ...
    "AMLVectorizer": {
      ...
      "properties": {
        "amlParameters": {
          "x-ms-client-name": "AMLParameters",
        ...
        "values": [
          {
            ...
            "name": "OpenAI_CLIP_Image_Text_Embeddings_vit_base_patch32"
          },
          {
            "value": "OpenAI-CLIP-Image-Text-Embeddings-ViT-Large-Patch14-336",
            "name": "OpenAI_CLIP_Image_Text_Embeddings_ViT_Large_Patch14_336"
          },
          {
            "value": "Facebook-DinoV2-Image-Embeddings-ViT-Base",
            "name": "Facebook_DinoV2_Image_Embeddings_ViT_Base"
          },
          {
            "value": "Facebook-DinoV2-Image-Embeddings-ViT-Giant",
            "name": "Facebook_DinoV2_Image_Embeddings_ViT_Giant"
          },
          {
            "value": "Cohere-embed-v3-english",
            "name": "Cohere_embed_v3_english"
          },
          {
            "value": "Cohere-embed-v3-multilingual",
            "name": "Cohere_embed_v3_multilingual"
          },
          {
            "value": "Cohere-embed-v4",
            "name": "Cohere_embed_v4",
            "description": "Cohere embed v4 model for generating embeddings from both text and images."
          }
        ]
      },
    ...
    "IndexingParameters": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/rest/api/searchservice/create-indexer#parameters"
      }
    },
    "IndexingParametersConfiguration": {
      ...
      "properties": {
        ...
        "markdownParsingSubmode": {
          "$ref": "#/definitions/MarkdownParsingSubmode",
          "x-nullable": true
        },
        "markdownHeaderDepth": {
          "$ref": "#/definitions/MarkdownHeaderDepth",
          "x-nullable": true
        },
        "documentRoot": {
          "type": "string",
    ...
    "FieldMappingFunction": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/search-indexer-field-mappings"
      }
    },
    "FieldMapping": {
      "type": "object",
    ...
    "SearchIndexer": {
      ...
      "properties": {
        ...
        "cache": {
          ...
          "externalDocs": {
            "url": "https://learn.microsoft.com/azure/search/search-howto-incremental-index"
          }
        }
      },
      "required": [
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/rest/api/searchservice/Indexer-operations"
      },
    ...
    "SearchField": {
      ...
      "properties": {
        ...
        "type": {
          ...
          "externalDocs": {
            "url": "https://learn.microsoft.com/rest/api/searchservice/supported-data-types"
          }
        },
        "key": {
          "type": "boolean",
        ...
        "vectorEncoding": {
          "x-ms-client-name": "VectorEncodingFormat",
        ...
        "synonymMaps": {
          "externalDocs": {
            "url": "https://learn.microsoft.com/rest/api/searchservice/Synonym-Map-operations"
          },
          "type": "array",
          "items": {
            "type": "string"
    ...
    "ScoringFunction": {
      ...
      "properties": {
        "type": {
          "type": "string",
          "description": "Indicates the type of function to use. Valid values include magnitude, freshness, distance, and tag. The function type must be lower case."
        },
        "fieldName": {
          "type": "string",
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/rest/api/searchservice/Add-scoring-profiles-to-a-search-index"
      },
    ...
    "ListIndexStatsSummary": {
      ...
      "properties": {
        "value": {
          "x-ms-client-name": "IndexesStatistics",
          "type": "array",
          "readOnly": true,
          "items": {
    ...
    "SearchIndexerSkillset": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-tutorial-blob"
      },
    ...
    "SearchIndexerKnowledgeStore": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/knowledge-store-projection-overview"
      },
      "description": "Definition of additional projections to azure blob, table, or files, of enriched data."
    },
    ...
    "SearchIndexerSkill": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-predefined-skills"
      },
    ...
    "KeyPhraseExtractionSkill": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-skill-keyphrases"
      },
    ...
    "OcrSkill": {
      ...
      "properties": {
        ...
        "lineEnding": {
          "$ref": "#/definitions/OcrSkillLineEnding",
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-skill-ocr"
      },
    ...
    "ImageAnalysisSkill": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-skill-image-analysis"
      },
    ...
    "LanguageDetectionSkill": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-skill-language-detection"
      },
    ...
    "ShaperSkill": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-skill-shaper"
      },
    ...
    "MergeSkill": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-skill-textmerger"
      },
    ...
    "EntityRecognitionSkill": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-skill-entity-recognition"
      },
    ...
    "SentimentSkill": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-skill-sentiment"
      },
    ...
    "SentimentSkillV3": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-skill-sentiment-v3"
      },
    ...
    "EntityLinkingSkill": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-skill-entity-linking-v3"
      },
    ...
    "EntityRecognitionSkillV3": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-skill-entity-recognition-v3"
      },
    ...
    "PIIDetectionSkill": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-skill-pii-detection"
      },
    ...
    "SplitSkill": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-skill-textsplit"
      },
    ...
    "CustomEntityLookupSkill": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/en-us/azure/search/cognitive-search-skill-custom-entity-lookup"
      },
    ...
    "TextTranslationSkill": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-skill-text-translation"
      },
    ...
    "DocumentExtractionSkill": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-skill-document-extraction"
      },
    ...
    "DocumentIntelligenceLayoutSkill": {
      ...
      "properties": {
        ...
        "outputMode": {
          "$ref": "#/definitions/DocumentIntelligenceLayoutSkillOutputMode",
          "x-nullable": true,
          "description": "Controls the cardinality of the output produced by the skill. Default is 'oneToMany'."
        },
        "markdownHeaderDepth": {
          "$ref": "#/definitions/DocumentIntelligenceLayoutSkillMarkdownHeaderDepth",
          "x-nullable": true,
    ...
    "ChatCompletionSkill": {
      ...
      "properties": {
        ...
        "extraParametersBehavior": {
          "$ref": "#/definitions/ChatCompletionExtraParametersBehavior",
    ...
    "ChatCompletionCommonModelParameters": {
      "type": "object",
      "x-ms-client-name": "CommonModelParameters",
      "properties": {
        "model": {
          "type": "string",
          "default": null,
    ...
    "ChatCompletionResponseFormat": {
      "type": "object",
      "x-ms-client-name": "ChatCompletionResponseFormat",
      "properties": {
        "type": {
          "type": "string",
          "enum": [
          ...
          "description": "Specifies how the LLM should format the response. Possible values: 'text' (plain string), 'json_object' (arbitrary JSON), or 'json_schema' (adheres to provided schema).",
          "default": "text",
          "x-ms-enum": {
        ...
        "jsonSchemaProperties": {
          "type": "object",
          "x-ms-client-name": "ChatCompletionSchemaProperties",
    ...
    "ChatCompletionSchema": {
      "type": "object",
      "x-ms-client-name": "ChatCompletionSchema",
      "x-nullable": true,
      ...
      "properties": {
        ...
        "required": {
          ...
          "description": "An array of the property names that are required to be part of the model's response. All properties must be included for structured outputs."
        },
        "additionalProperties": {
          "type": "boolean",
          "default": false,
    ...
    "WebApiSkill": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/azure/search/cognitive-search-custom-skill-web-api"
      },
    ...
    "AmlSkill": {
      ...
      "externalDocs": {
        "url": "https://learn.microsoft.com/en-us/azure/search/cognitive-search-aml-skill"
      },
    ...
    "AzureOpenAIEmbeddingSkill": {
      "type": "object",
      "x-ms-client-name": "AzureOpenAIEmbeddingSkill",
    ...
    "VisionVectorizeSkill": {
      "type": "object",
      "x-ms-client-name": "VisionVectorizeSkill",
    ...
    "AzureOpenAITokenizerParameters": {
      ...
      "properties": {
        "encoderModelName": {
          "$ref": "#/definitions/EncoderModelName",
          "x-nullable": true,
    ...
    "SynonymMap": {
      ...
      "properties": {
        ...
        "synonyms": {
          ...
          "externalDocs": {
            "url": "https://learn.microsoft.com/rest/api/searchservice/Create-Synonym-Map#SynonymMapFormat"
          }
        },
        "encryptionKey": {
          "$ref": "#/definitions/SearchResourceEncryptionKey",
    ...
    "ServiceLimits": {
      ...
      "properties": {
        ...
        "maxStoragePerIndex": {
          "x-ms-client-name": "maxStoragePerIndexInBytes",
          "type": "integer",
          "format": "int64",
          "x-nullable": true,
