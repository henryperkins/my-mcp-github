...
export class ServiceTool extends DynamicTool {
  ...
  static readonly description = "Service utilities for Azure Search. USAGE: Call with {'operation': '<op>', 'params': {...}}. Operations: serviceStats, indexStatsSummary, analyzeText, listSynonymMaps, getSynonymMap, createOrUpdateSynonymMap, deleteSynonymMap.";
