...
export class DocumentTool extends DynamicTool {
  ...
  static readonly description = "Document operations for Azure Search. USAGE: Call with {'operation': '<op>', 'params': {...}}. Operations: search, get, count, upload, merge, mergeOrUpload, delete.";
