...
export class KnowledgeSourceTool extends DynamicTool {
  ...
  static readonly description = "Knowledge source operations for Azure Search. USAGE: Call with {'operation': '<op>', 'params': {...}}. Operations: list, get, create, update, delete, createBlob, createWeb.";
